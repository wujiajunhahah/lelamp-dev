...
MODEL_BASE_URL="${MODEL_BASE_URL:-https://dashscope.aliyuncs.com/api-ws/v1/realtime}"
MODEL_NAME="${MODEL_NAME:-qwen3.5-omni-plus-realtime}"
MODEL_VOICE="${MODEL_VOICE:-Tina}"
...
Optional:
  ...
  --repo-url URL              Top-level repo cloned by first boot bootstrap service
